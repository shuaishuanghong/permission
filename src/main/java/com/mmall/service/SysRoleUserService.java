...
public class SysRoleUserService {
    ...
    public List<SysUser> getListByRoleId(int roleID){
       List<Integer> userListId=sysRoleUserMapper.getUserIdListByRoleId(roleID);
       if(CollectionUtils.isEmpty(userListId)){
           return Lists.newArrayList();
       }
      return   sysUserMapper.getByIdList(userListId);
    }
